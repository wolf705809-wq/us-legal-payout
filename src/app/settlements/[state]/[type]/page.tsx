    ...
    <>
      ...
      <div className="flex flex-col min-h-screen" style={{ backgroundColor: '#111827', color: 'white' }}>
        ...
        <section style={{ background: 'linear-gradient(160deg, #0F1D32 0%, #0F1D32 100%)', borderBottom: '3px solid #D4A84B' }}>
          <div className="max-w-4xl mx-auto px-6 py-16">
            <div className="text-xs font-bold tracking-widest uppercase mb-3" style={{ color: '#D4A84B', letterSpacing: '0.2em' }}>
              ...
              {' / '}
              <span className="text-gray-400">{at.name}</span>
            </div>
        ...
        <div className="max-w-4xl mx-auto px-6 py-12 w-full space-y-14">
          ...
          {/* ── Quick Facts ── */}
          <section>
            <h2 className="text-xl font-bold text-white mb-5">Quick Facts: {sd.name} Truck Accidents</h2>
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 items-stretch">
              {[
                ...
                { label: 'Federal Min. Insurance', value: at.slug === 'hazmat-spill' ? '$1M–$5M' : '$750,000' },
                {
